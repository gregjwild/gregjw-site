...
In the end, I had to add the code to the blog page component. !(https://github.com/gregjwild/gregjw-site/commit/d0318643b73c2411bc1159edd996624c21fcb460)[Check out the git commit] if you're interested.